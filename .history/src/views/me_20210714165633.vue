 ...
 * @LastEditTime: 2021-07-14 16:56:32
...
.user_info {
    height: 122px;
    background-image: linear-gradient( #E8ECF7 0%, #FFFFFF 100%);
    display: flex;
    align-items: center;
  .user_image {
    margin-left: 16px;
    ...
    .img_cover{
        text-align: center;
        position: absolute;/*因为父元素使用了相对定位，所以这里的绝对定位就是相对于父元素的*/
        top: 50px;
        width: 77.5px;
        height: 30px;
