 ...
 * @LastEditTime: 2021-07-12 17:52:55
...
<van-config-provider :theme-vars="themeVars">
  ...
  <div class="car_nav">
    <van-tag plain size="large" color="#ffe1e1" text-color="#ad0000" type="primary">全部</van-tag>
    <van-tag class="tag" plain size="large" type="primary">轿车</van-tag>
    <van-tag class="tag" plain size="large" type="primary">SUV</van-tag>
    <van-tag class="tag" plain size="large" type="primary">标签</van-tag>
  </div>
