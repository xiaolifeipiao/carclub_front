 ...
 * @LastEditTime: 2021-07-14 18:03:53
...
<template>
    ...
    <div class="brand">
        ...
        <van-grid-item v-for="item in brandList" :key="item.brand_id"  :to="{path: 'BrandCarSeries', params:{brandId:item.brand_id}}">
    ...
    <van-config-provider :theme-vars="themeVars">
        ...
        <van-grid-item v-for="item in related" :key="item.brand_id"  :to="{name:'CarDetails',params: { brandId:item.brand_id,carSeriesId:item.id}}">
...
export default defineComponent({
  ...
  setup: () => {
    const carTitle= ref('车型大会')
     const themeVars = {
         gridItemContentPadding:'5px',
        //  indexAnchorBackgroundColor:'#86D181'
    };
    // 品牌数据
