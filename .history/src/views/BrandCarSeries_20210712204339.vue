 ...
 * @LastEditTime: 2021-07-12 20:43:39
...
<van-config-provider :theme-vars="themeVars">
  ...
  <div class="car_nav">
    <van-tag plain size="large"  text-color="#1F2129"  @click="selectClick('a')"  type="primary">全部</van-tag>
    <van-tag plain class="tag" color="#F6F7FB" @click="selectClick('b')"  size="large" text-color="#1F2129" type="primary">轿车</van-tag>
    <van-tag plain class="tag" color="#F6F7FB"  @click="selectClick('c')"   size="large" text-color="#1F2129" type="primary">SUV</van-tag>
    <van-tag plain class="tag" color="#F6F7FB"  @click="selectClick('d')"   size="large" text-color="#1F2129" type="primary">SUV</van-tag>
  </div>
...
import {select} from '@utils/enumType'
