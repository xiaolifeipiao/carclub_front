 ...
 * @LastEditTime: 2021-07-12 21:25:05
...
<template>
  <van-config-provider :theme-vars="themeVars">
    ...
    <div class="car_nav">
      ...
      <van-tag  class="tag"  :color="taggColor !== 2? '#F6F7FB' : ''"  @click="selectClick(2)"   size="large" text-color="#1F2129" >SUV</van-tag>
      <van-tag  class="tag"  :color="taggColor !== 3? '#F6F7FB' : ''"  @click="selectClick(3)"   size="large" text-color="#1F2129" >MPV</van-tag>
    </div>
