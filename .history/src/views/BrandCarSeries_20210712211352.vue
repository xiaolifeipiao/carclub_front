 ...
 * @LastEditTime: 2021-07-12 21:13:52
...
<van-config-provider :theme-vars="themeVars">
  ...
  <div class="car_nav">
    <van-tag plain size="large" :color="taggColor !== 0? '#F6F7FB' : ''"  @click="selectClick(0)"  text-color="#1F2129"    type="primary">全部</van-tag>
...
export default defineComponent({
  ...
  setup: (props) => {
    ...
    const themeVars = {
      ...
      const onClick = (name, title) => console.log(name);
