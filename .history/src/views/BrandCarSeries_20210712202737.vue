 ...
 * @LastEditTime: 2021-07-12 20:27:37
...
<van-config-provider :theme-vars="themeVars">
  ...
  <div class="car_nav">
    <van-tag  :plain='false' size="large"  color="#F6F7FB" text-color="#1F2129" type="primary">全部</van-tag>
    <van-tag class="tag" color="#F6F7FB"  size="large" text-color="#1F2129" type="primary">轿车</van-tag>
    <van-tag class="tag" color="#F6F7FB"  size="large" text-color="#1F2129" type="primary">SUV</van-tag>
    <van-tag class="tag" color="#F6F7FB"  size="large" text-color="#1F2129" type="primary">SUV</van-tag>
  </div>
