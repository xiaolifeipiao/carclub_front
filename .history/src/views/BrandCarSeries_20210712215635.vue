 ...
 * @LastEditTime: 2021-07-12 21:56:35
...
<template>
  ...
  <van-list
  v-model:loading="true"
  :finished="true"
  finished-text="没有更多了"
>
  <div v-for="item in 10" :key="item" :title="item" >{{item}}</div>
</van-list>
  <van-pull-refresh v-model="state.refreshing" @refresh="onRefresh">
      <van-list
        ...
        @load="onLoad"
      >
        <div v-for="item in state.list" :key="item" :title="item" >{{item}}</div>
      </van-list>
    </van-pull-refresh>
</template>
