 ...
 * @LastEditTime: 2021-07-12 21:26:26
...
<template>
  <van-config-provider :theme-vars="themeVars">
    ...
    <div class="car_nav">
      ...
      <van-tag :plain='taggColor === 0' class="tag" :color="taggColor !== 1? '#F6F7FB' : ''"  @click="selectClick(1)"  size="large" text-color="#1F2129">轿车</van-tag>
      <van-tag :plain='taggColor === 0'  class="tag"  :color="taggColor !== 2? '#F6F7FB' : ''"  @click="selectClick(2)"   size="large" text-color="#1F2129" >SUV</van-tag>
      <van-tag :plain='taggColor === 0'  class="tag"  :color="taggColor !== 3? '#F6F7FB' : ''"  @click="selectClick(3)"   size="large" text-color="#1F2129" >MPV</van-tag>
    </div>
