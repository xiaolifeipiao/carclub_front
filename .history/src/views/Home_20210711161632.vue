 ...
 * @LastEditTime: 2021-07-11 16:16:32
...
<template>
    ...
    <van-config-provider :theme-vars="themeVars">
     ...
     <div class="adv">
         ...
         <span class="adv_content">哈弗H6、缤越Pro、轩逸、红旗HS7、奥迪A4asdfasdfas</span>
         <van-icon class="adv_icon" name="play" />
     </div>
    <!-- 标签 -->
...
import {Grid, GridItem,Image,Tag,Icon  } from 'vant'
