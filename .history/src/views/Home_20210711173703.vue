 ...
 * @LastEditTime: 2021-07-11 17:37:03
...
<template>
    ...
    <van-index-bar :index-list="indexList" highlight-color="#89BCD7">
        <div>
            <van-index-anchor class="index_title" v-for="(item,key) in indexList" :index="key" :key="item">{{item}}</van-index-anchor>
            <van-cell>
                <!-- 使用 title 插槽来自定义标题 -->
                <template #title>
                    <van-image class="index_cell_url" src="https://p1-dcd.byteimg.com/img/mosaic-legacy/1dd5000048d6334c26b4~tplv-resize:100:0.png"></van-image>
