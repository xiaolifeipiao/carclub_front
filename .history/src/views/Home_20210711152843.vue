 ...
 * @LastEditTime: 2021-07-11 15:28:43
...
<template>
    ...
    <p class="related">猜你喜欢</p>
     <van-grid :column-num="3" :border="false" :gutter="2" square>
        <van-grid-item class="van_grid_item_related" v-for="item in related" :key="item.id"  :to="{path: 'test', query: {id: item.id }}">
