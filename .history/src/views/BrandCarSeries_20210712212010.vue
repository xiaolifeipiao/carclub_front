 ...
 * @LastEditTime: 2021-07-12 21:20:10
...
<template>
  <van-config-provider :theme-vars="themeVars">
    ...
    <div class="car_nav">
      ...
      <van-tag  class="tag" :color="taggColor !== 1? '#b8bbc7' : ''"  @click="selectClick(1)"  size="large" text-color="#1F2129" type="primary">轿车</van-tag>
      <van-tag  class="tag"  :color="taggColor !== 2? '#b8bbc7' : ''"  @click="selectClick(2)"   size="large" text-color="#1F2129" type="primary">SUV</van-tag>
      <van-tag  class="tag"  :color="taggColor !== 3? '#b8bbc7' : ''"  @click="selectClick(3)"   size="large" text-color="#1F2129" type="primary">MPV</van-tag>
    </div>
