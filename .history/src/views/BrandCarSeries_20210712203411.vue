 ...
 * @LastEditTime: 2021-07-12 20:34:11
...
<van-config-provider :theme-vars="themeVars">
  ...
  <div class="car_nav">
    ...
    <van-tag plain class="tag" color="#F6F7FB" @click="selectClick"  size="large" text-color="#1F2129" type="primary">轿车</van-tag>
    <van-tag plain class="tag" color="#F6F7FB"  @click="selectClick"   size="large" text-color="#1F2129" type="primary">SUV</van-tag>
    <van-tag plain class="tag" color="#F6F7FB"  @click="selectClick"   size="large" text-color="#1F2129" type="primary">SUV</van-tag>
  </div>
