 ...
 * @LastEditTime: 2021-07-12 21:03:50
...
<van-config-provider :theme-vars="themeVars">
  ...
  <div class="car_nav">
    <van-tag plain size="large" :color="taggColor0 === true? '#F6F7FB' : ' '"  text-color="#1F2129"  @click="selectClick(0)"  type="primary">全部</van-tag>
    <van-tag plain class="tag" :color="taggColor === true? '#F6F7FB' : ' '" @click="selectClick(1)"  size="large" text-color="#1F2129" type="primary">轿车</van-tag>
    <van-tag plain class="tag" color="#F6F7FB"  @click="selectClick(2)"   size="large" text-color="#1F2129" type="primary">SUV</van-tag>
    <van-tag plain class="tag" color="#F6F7FB"  @click="selectClick(3)"   size="large" text-color="#1F2129" type="primary">MPV</van-tag>
  </div>
