 ...
 * @LastEditTime: 2021-07-10 19:05:47
...
<van-form @submit="onSubmit">
  ...
  <div style="margin: 16px;">
    <van-button block color="#FFCC32" type="default" native-type="submit" class="btn_sub">
    <span class="btn_sub_text">确认</span>
    </van-button>
  </div>
</van-form>
</van-config-provider>
