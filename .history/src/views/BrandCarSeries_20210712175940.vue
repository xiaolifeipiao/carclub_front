 ...
 * @LastEditTime: 2021-07-12 17:59:07
...
<van-config-provider :theme-vars="themeVars">
  ...
  <div class="car_nav">
    ...
    <van-tag class="tag" color="#F7F8FC" plain size="large" text-color="#1F2129" type="primary">轿车</van-tag>
    <van-tag class="tag" color="#F7F8FC" plain size="large" text-color="#1F2129" type="primary">SUV</van-tag>
    <van-tag class="tag" color="#F7F8FC" plain size="large" text-color="#1F2129" type="primary">SUV</van-tag>
  </div>
