 ...
 * @LastEditTime: 2021-07-11 15:11:30
...
export default defineComponent({
  ...
  setup: () => {
    ...
    const related:Array<brandModel>=[
         ...
         {
            id:'4',name:'指南者',brand_url:'src/assets/webp/1.webp'
        },
         {
            id:'5',name:'奔驰GIC',brand_url:'src/assets/webp/1.webp'
        },
         {
            id:'6',name:'奔驰GIC',brand_url:'src/assets/webp/1.webp'
        },
    ]
    return {
        title,
