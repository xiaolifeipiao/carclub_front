 ...
 * @LastEditTime: 2021-07-15 14:53:18
...
<template>
    ...
    <van-popup v-model:show="showCity" position="bottom" :style="{ height: '100%' }" >
        <nav-bar title="标题"  left-arrow @click-left="onClickLeft"></nav-bar>
    </van-popup>
</template>
<script lang="ts">
import { defineComponent ,onUnmounted,ref,reactive} from 'vue'
import { ActionSheet,Form, Field, CellGroup,Button ,Cell,Toast,Popup,NavBar} from 'vant';
