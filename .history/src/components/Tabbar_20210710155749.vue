 ...
 * @LastEditTime: 2021-07-10 15:57:45
...
<van-config-provider :theme-vars="themeVars">
    <van-tabbar v-model="active">
        <van-tabbar-item badge="3" replace to="/home" >
            <span>选车</span>
            <template #icon="props">
            <img :src="props.activeCar ? iconCar.active : iconCar.inactive" />
            </template>
        </van-tabbar-item>
        <van-tabbar-item badge="3" replace to="/home" >
            <span>我的</span>
            <template #icon="props">
            <img :src="props.activeMe ? iconMe.active : iconMe.inactive" />
            </template>
        </van-tabbar-item>
    </van-tabbar>
</van-config-provider>
