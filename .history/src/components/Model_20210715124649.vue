 ...
 * @LastEditTime: 2021-07-15 12:46:49
        ...
        <van-action-sheet v-model:show="showOn" title="立即预约试驾">
            ...
            <van-form class="from" @submit="onSubmit">
                <van-cell-group>
                    ...
                    :rules="[{ validator, message: '请输入正确内容' },{ required: true, message: '请填写手机号' }]" />
                </van-cell-group>
                <div >
...
export default defineComponent({
    ...
    setup() {
        ...
        const validator = (val) => /^1(3[0-9]|4[01456879]|5[0-3,5-9]|6[2567]|7[0-8]|8[0-9]|9[0-3,5-9])d{8}$/.test(val);
        const themeVars = {
