 ...
 * @LastEditTime: 2021-07-11 21:00:21
...
<van-config-provider :theme-vars="themeVars">
    <van-row justify="space-between" align="center" class="car">
        ...
        <van-col span="12">
            ...
            <div style="display:block"><van-rate
            v-model="value"
           readonly 
            :size="12"
            color="#ffd21e"
            void-icon="star"
            void-color="#eee"
           /><span class="car_sart" style="font-size: 12px;">{{value}}</span></div>
           
           <div  class="car_price" style="display:block">指导价：28.46万起</div>
        </van-col>
        <van-col span="3">
