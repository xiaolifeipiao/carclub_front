 ...
 * @LastEditTime: 2021-07-15 14:40:22
...
<template>
    ...
    <van-popup v-model:show="showCity" position="top" :style="{ height: '30%' }" />
</template>
<script lang="ts">
import { defineComponent ,onUnmounted,ref,reactive} from 'vue'
import { ActionSheet,Form, Field, CellGroup,Button ,Cell,Toast} from 'vant';
