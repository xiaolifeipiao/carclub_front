 ...
 * @Description: car360度旋转
 * @version: 0.0.0
 * @Date: 2021-07-13 15:52:00
 * @LastEditTime: 2021-07-13 21:37:41
 * @LastEditors: xiaolifeipiao
 * @FilePath: \src\components\CarRotates .vue
-->
<template>
  <div class="image-container">
      <div class="cpt-wg-360">
           <div 
            ...
            logo-src='https://pic.stackoverflow.wiki/uploadImages/114/37/227/188/2021/07/13/17/59/e58c2e31-ede9-474e-842d-56666d8094db.svg'
            data-amount="36"
            data-magnifier="3"
            ></div>
        </div>
...
.image-container {
    ...
    width: 100%;
    height: 160px;
    background-image: linear-gradient( #E0E9F4 0%, #FFFFFF 35%, #FCFDFE 69%, #E0E9F4 98%);
    background-image: -webkit-linear-gradient(180deg, #E0E9F4 0%, #FFFFFF 35%, #FCFDFE 69%, #E0E9F4 98%);
}
.cpt-wg-360 {
   position: absolute;
    left: 50%;
