 ...
 * @LastEditTime: 2021-07-11 20:59:03
...
<van-config-provider :theme-vars="themeVars">
    <van-row justify="space-between" align="center" class="car">
        <van-col span="8">
            <van-image
            class="car_image"
            fit="cover"
        ...
        <van-col span="12">
            <div>宝马2系旅行车新能源(进口)</div>
            <div style="display:block"><van-rate style="vertical-align: middle;"
            v-model="value"
           readonly 
            :size="12"
            color="#ffd21e"
            void-icon="star"
            void-color="#eee"
           /><span style="font-size: 12px;">{{value}}</span></div>
           
           <div style="display:block">指导价：28.46万起</div>
        </van-col>
        <van-col span="3">
