 ...
 * @LastEditTime: 2021-07-12 11:14:13
...
<van-config-provider :theme-vars="themeVars">
    <van-row  align="center" class="car">
        ...
        <van-col span="11">
            <div class="car_name">{{rateList.carSeriesName}}</div>
            <div v-if="!isCarRate">
                <my-rate :rateValue="rateList.myRateValue">
                    <template v-slot:rate_title>
                        我的：
                    </template>
                </my-rate>
                <my-rate :rateValue="rateList.allRateValue">
                    <template v-slot:rate_title>
                        综合：
                    </template>
                </my-rate>
            ...
            <div v-else>
                <my-rate :rateValue="rateList.testRateScore"></my-rate>
                 <div class="car_price">指导价：{{rateList.carSeriesPrice}}万起</div>
            </div>
        </van-col>
        <van-col span="5">
...
export default defineComponent({
  ...
  setup: (props) => {
    ...
    isCarRate.value =props.isCarRate;
