 ...
 * @LastEditTime: 2021-07-15 15:56:20
    ...
    :style="{ height: '100%' }" >
     <van-cell icon="arrow-left" @click="cancelCityShow">
        ...
        <div class="city_auto_location">
          <span><button class="btn_city_content">重庆</button></span> 
            <span class="replay_location">
                <van-icon size="14px" name="replay" />
                <button>重新定位 </button>
            </span>
        </div>
    </van-popup>
...
import { ActionSheet,Form, Field, CellGroup,Button ,Cell,Toast,Popup,Divider} from 'vant';
