 ...
 * @LastEditTime: 2021-07-11 21:45:15
...
<van-config-provider :theme-vars="themeVars">
    <van-row justify="space-between" align="center" class="car">
        ...
        <van-col span="12">
           ...
           <div  class="car_price">指导价：28.46万起</div>
        </van-col>
        <van-col span="5">
            <van-tag class="car_tag" color="#FFCC32"  text-color="#1A1A1A" size="medium" type="primary">试驾</van-tag>
        </van-col>
    </van-row>
</van-config-provider>
