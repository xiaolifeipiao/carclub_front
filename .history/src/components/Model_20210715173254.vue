 ...
 * @LastEditTime: 2021-07-15 17:32:54
...
<template>
    <van-config-provider :theme-vars="themeVars">
        ...
        <van-cell icon="arrow-left" @click="cancelCityShow">
            ...
            <!-- 索引 -->
            <van-index-bar :index-list="indexList.initials.toLocaleUpperCase()" highlight-color="#89BCD7" @select="indexOnSelect">
                <van-index-anchor class="index_title"   index="选" v-show="false"></van-index-anchor>
                <div v-for="(item,key) in indexList"  :index="key">
                    <van-index-anchor :index="item.initials.toLocaleUpperCase() " />
...
export default defineComponent({
    ...
    setup() {
       const router = useRouter()
        ...
        // 索引数据
        const indexList:Array<cityModel> = [
    {
        "city": [
            {
                "city_name": "安阳",
