...
@LastEditTime: 2021-07-10 01:55:29
...
export const userInfoRequest = () => {
  console.log(https().request<RootObject<UserInfoModel>>('user', Method.GET, undefined, ContentType.form));
  return https().request<RootObject<UserInfoModel>>('user', Method.GET, undefined, ContentType.form)
}
